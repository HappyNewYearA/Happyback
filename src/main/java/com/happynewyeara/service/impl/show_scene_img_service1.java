...
public class show_scene_img_service1 implements show_scene_img_service {
    ...
    public List<Object> show_scene_img(String scene_name,String phone_num) {
...
//        }
   /*     List<img> img_list1 = imgMapper.get_img1(user_id, scene_id);
        ...
        List<Map<String, String>> img3 = imgMapper.get_img3(scene_id);
        return Collections.singletonList(img3);
